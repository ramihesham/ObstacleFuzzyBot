...
rule10 = ctrl.Rule(front_ultrasonic['medium'] & front_ultrasonic['near'] & right_ultrasonic['near'], left_motor['-ve_fast'], right_motor['-ve_fast'])
rule11 = ctrl.Rule(front_ultrasonic['medium'] & front_ultrasonic['near'] & right_ultrasonic['medium'], left_motor['-ve_fast'], right_motor['-ve_fast'])
rule12 = ctrl.Rule(front_ultrasonic['medium'] & front_ultrasonic['near'] & right_ultrasonic['far'], left_motor['-ve_fast'], right_motor['-ve_fast'])
rule13 = ctrl.Rule(front_ultrasonic['medium'] & front_ultrasonic['medium'] & right_ultrasonic['near'], left_motor['-ve_fast'], right_motor['-ve_fast'])
rule14 = ctrl.Rule(front_ultrasonic['medium'] & front_ultrasonic['medium'] & right_ultrasonic['medium'], left_motor['-ve_fast'], right_motor['+ve_slow'])
rule15 = ctrl.Rule(front_ultrasonic['medium'] & front_ultrasonic['medium'] & right_ultrasonic['far'], left_motor['+ve_fast'], right_motor['+ve_slow'])
rule16 = ctrl.Rule(front_ultrasonic['medium'] & front_ultrasonic['far'] & right_ultrasonic['near'], left_motor['-ve_fast'], right_motor['-ve_fast'])
rule17 = ctrl.Rule(front_ultrasonic['medium'] & front_ultrasonic['far'] & right_ultrasonic['medium'], left_motor['+ve_fast'], right_motor['+ve_slow'])
rule18 = ctrl.Rule(front_ultrasonic['medium'] & front_ultrasonic['far'] & right_ultrasonic['far'], left_motor['+ve_fast'], right_motor['+ve_slow'])
